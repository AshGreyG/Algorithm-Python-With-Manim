...
def dynamic_benchmark_time(
    ...
    """
    This is the benchmark function for insertion sort / binary insertion sort.
...
if __name__ == "__main__" :
    ...
    plt.savefig("Insertion-Sort-Benchmark-Time.svg", format = "svg")
    ...
    plt.legend(loc = "upper left", prop = libertinus_font)
    plt.savefig("Insertion-Sort-Benchmark-Memory.svg", format = "svg")
